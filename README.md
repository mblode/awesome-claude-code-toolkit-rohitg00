...
| [mblode/agent-skills](https://github.com/mblode/agent-skills) | `npx skills add mblode/agent-skills -g --agent codex claude-code -y` | 26 skills for UI audits, typography, docs, PR review, and releases. |
